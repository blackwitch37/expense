...
export const routes: Routes = [
  ...
  // },
  {
    ...
    children: [
      ...
      { path: 'import/importdata', component: ImportdataComponent},
      { path: 'import/importaccount', component: ImportaccountComponent},
      { path: 'master/account', component: AccountComponent},
      { path: 'master/user', component: UserComponent},
      { path: 'master/userlevel', component: UserlevelComponent},
      { path: 'master/location', component: LocationComponent},
      { path: 'transaction/expense', component: ExpenseComponent},
